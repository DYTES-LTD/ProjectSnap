...
function SnapInterFace({MetaData, isheader, isfooter,iswifi}) {
  ...
  return (
   <div className='ssclass w-full h-full mt-1 p-2'>
    ...
    <div
        ...
        style={{
          height: `${MetaData.height>65?MetaData.height:72}vh`,
          width: `${MetaData.width}vw`,
          minHeight: '62vh',
          minWidth: '320px', // good for most mobile screens
              ...
              <div className="w-full flex flex-row p-2 items-center">
                ...
                <div>
                  ...
                  {!MetaData.airplanemode?<div className="flex flex-row gap-[2px] items-end rounded-xl p-1">
                    ...
                    ):<span className="iphonebattery   w-[20px] lg:w-[1.6vw] ml-1 lg:h-[2vh] h-[15px] md:w-[25px] flex justify-end"></span>}
